...
#		@venues = Venue.select("venues.*, neighborhoods.*, venue_events.*").joins(:neighborhood).joins('LEFT OUTER JOIN venue_events ON venues.id = venue_events.venue_id')
		@venues = Venue.select("DISTINCT(venues.name), venues.id, venues.name, venues.phone, venues.neighborhood_id, venues.file_name, neighborhoods.id, venue_events.id, venue_events.name").joins(:neighborhood).joins('LEFT OUTER JOIN venue_events ON venues.id = venue_events.venue_id')
